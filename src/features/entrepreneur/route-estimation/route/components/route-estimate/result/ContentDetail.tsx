...
import { Card, Col, Descriptions, DescriptionsProps, Image, Row } from 'antd';
              ...
              <Card
                cover={(
                  <figure className='h-44 relative overflow-hidden'>
                    <Image
                      src={detail.towing_vehicle.vehicle_picture}
            ...
            <Col xs={24} sm={12} md={12} lg={8} xl={8} xxl={8}>
              <Card
                cover={(
                  <figure className='h-44 relative overflow-hidden'>
                    <Image
                      src={detail.semi_trailer_vehicle.vehicle_picture}
                      alt={'semi-vehicle'}
                      width={'100%'}
                      height={'100%'}
                      className='object-cover object-center'
            ...
            <Col xs={24} sm={12} md={12} lg={8} xl={8} xxl={8}>
              <Card
                cover={(
                  <figure className='h-44 relative overflow-hidden'>
                    <Image
                      src={detail.etc_vehicle.vehicle_picture}
                      alt={'etc-vehicle'}
                      width={'100%'}
                      height={'100%'}
                      className='object-cover object-center'
