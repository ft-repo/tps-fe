    ...
    return (
      <div>
        ...
        <ol className='list-decimal list-inside mb-5'>
          ...
          <li>แผนผังถนนของทางหลวงชนบทที่ขออนุญาต เช่น ถนนหลวงชนบท (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : ผู้ยื่นคำขอเป็นผู้ลงนาม</span></li>
          <li>สำเนาบัตรผู้จัดการเดินรถและประวัติด้านพาหนะที่ได้รับอนุญาตใช้บนถนนสาธารณะ พร้อมแสดงหลักฐานการรับรองเจ้าหน้าที่ (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : รับรองสำเนาถูกต้อง</span></li>
          <li>รูปถ่ายลักษณะพาหนะ (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรเครื่องกลผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>รูปแบบขบวนพาหนะ โดยแสดงถึงขนาด ระยะ และน้ำหนักลงเพลาของขบวนพาหนะ (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรเครื่องกลผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>รูปแบบขบวนพาหนะโดยแสดงถึงมิติขนาดรวมของขบวนบรรทุก (กว้าง ยาว สูง) ทั้งก่อนและหลังมีการบรรทุกสิ่งของแล้ว(ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรเครื่องกลผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>กรณีใช้ชิ้นส่วนสำเร็จรูปประกอบมากกว่า 1 ชิ้น ให้แสดงรายละเอียดและน้ำหนักรวมของสิ่งของที่ต้องการขนส่ง(ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรโยธาผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>รูปแบบพาหนะโดยแสดงถึงรัศมีวงเลี้ยว (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรเครื่องกลผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>รายการคำนวณแรงที่เกิดขึ้นต่อโครงสร้างสะพานทางผ่านในเส้นทางที่ขออนุญาต เมื่อมีการบรรทุกน้ำหนักแล้ว(ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรโยธาผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>รายการคำนวณแรงที่เกิดขึ้นต่อโครงสร้างสะพานทางผ่านในเส้นทางที่กำหนดก่อนการขออนุญาต เมื่อมีการบรรทุกน้ำหนักแล้ว (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรโยธาผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>หนังสือรับรองของวิศวกรโยธาผู้คำนวณโครงสร้างสะพาน พร้อมสำเนาใบอนุญาตผู้ประกอบวิชาชีพ (ระดับไม่ต่ำกว่าสามัญวิศวกร) (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรโยธาผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>หนังสือรับรองของวิศวกรโยธาผู้คำนวณโครงสร้างทาง พร้อมสำเนาใบอนุญาตผู้ประกอบวิชาชีพ (ระดับไม่ต่ำกว่าสามัญวิศวกร) (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรโยธาผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>หนังสือรับรองของวิศวกรเครื่องกลผู้คำนวณน้ำหนักลงเพลา พร้อมสำเนาใบอนุญาตผู้ประกอบวิชาชีพ (ระดับไม่ต่ำกว่าสามัญวิศวกร) (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรเครื่องกลผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>หนังสือรับรองของวิศวกรเครื่องกลผู้คำนวณแรงดึงหรือแรงฉุด พร้อมสำเนาใบอนุญาตผู้ประกอบวิชาชีพ (ระดับไม่ต่ำกว่าสามัญวิศวกร) (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : วิศวกรเครื่องกลผู้คำนวณลงนามรับรอง ทุกแผ่น</span></li>
          <li>รูปแบบการบริหารจัดการด้านความปลอดภัยในการใช้ทางหลวง (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : ผู้ขออนุญาตเป็นผู้ลงนาม</span></li>
          <li>แผนที่เส้นทางเดินรถ (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : ผู้ขออนุญาตเป็นผู้ลงนาม</span></li>
          <li>แผนและระยะเวลาการดำเนินงาน (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : ผู้ขออนุญาตเป็นผู้ลงนาม</span></li>
          <li>ที่อยู่และสิ่งที่ใช้ในการจัดส่งเอกสาร (ฉบับจริง 1 ชุด สำเนา 4 ชุด) <span className='text-[#FF9C00]'>หมายเหตุ : ผู้ขออนุญาตเป็นผู้ลงนาม</span></li>
          <li>หนังสือมอบอำนาจ (กรณีไม่สามารถมาดำเนินการด้วยตนเอง) ต้องติดอากรแสตมป์ 10 หรือ 30 บาท พร้อมสำเนาบัตรประชาชนของผู้มอบอำนาจและผู้รับมอบอำนาจ <span className='text-[#FF9C00]'>หมายเหตุ : หากผู้มอบอำนาจเป็นบุคคลธรรมดา ต้องแนบสำเนาบัตรประจำตัว ประชาชน ของผู้มอบอำนาจรับรองสำเนาถูกต้อง หากผู้มอบอำนาจเป็นนิติบุคคล ต้องแนบหนังสือรับรองจดทะเบียนเป็นนิติบุคคล พร้อมประทับตราและสำเนาบัตรประจำตัวประชาชน ผู้มีอำนาจลงนามรับรองสำเนาถูกต้อง และประทับตราด้วย</span></li>
        </ol>
