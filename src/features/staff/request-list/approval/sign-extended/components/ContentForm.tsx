...
const ContentForm: React.FC<Props> = (props) => {
  ...
  const form = useForm<FieldType>({
    defaultValues: {
      ...
      remark: petition_extended_status[1]?.remark || '',
    },
    disabled: disabled
  })
  ...
  }, [dispatch, navigate, petition_extended.overview.search, state?.petition_id, state?.status_id])
        ...
        setValue('file_id.file', [
          {
            ...
            // name: extractFileName(String(petition_extended_status[1]?.document_url)),
            name: 'หนังสืออนุญาต',
            // percent: 100,
            uid: '1',
            status: 'done',
