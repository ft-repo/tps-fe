...
const PetitionDetail: React.FC<Props> = (props) => {
  ...
  const items: DescriptionsProps['items'] = [
    ...
    },
    {
      key: '2',
      label: 'วันที่ตรวจสอบ',
      children: <p>{dayjs(petition_status[0]?.created_at).format('DD/MM/YYYY') || '-'}</p>,
    },
    {
      key: '3',
      label: 'ตรวจสอบโดย',
    ...
    },
    {
      ...
      children: <p className={petition_status[0]?.canceled_remark ? 'text-red-500' : ''}>{petition_status[0]?.canceled_remark || '-'}</p>,
    },
  ]
